// Задача № 19 Вводим пятизначное целое число, проверяем является ли введенное число Палиндром? 
// Проверяем количество символов в строке:

Console.WriteLine("\nЗадача № 19 (метод)");
Console.WriteLine("  Проверяем является ли введенное число Палиндром?");
